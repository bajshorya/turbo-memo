...
export default function Home() {
  ...
  const filteredTweets = tweetSuggestions.filter(tweet => {
    const matchesExchange = selectedExchange === 'all-dex' || tweet.exchange === selectedExchange
        ...
        <div className="flex-1 relative">
          <div className="relative">
              ...
              <div className="pr-4">
                ...
                {filteredTweets.length > 0 ? (
                  ...
                  <div className="text-center py-12 col-span-2">
                    <p className="text-gray-500 text-lg">No tweets found for the selected filters.</p>
                    <p className="text-gray-400 text-sm mt-2">Try adjusting your search or exchange selection.</p>
                  </div>
                )}
              </div>
            </ScrollArea>
            ...
            <div
              ...
              style={{
                height: '160px',
                background: 'linear-gradient(to top, #e4ebf2 0%, transparent 100%)'
              }}
            />
          </div>
          ...
          {filteredTweets.length > 0 && (
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-30">
              <Button variant="outline" className="text-[#1a1a3e] border-gray-300 hover:bg-white shadow-lg bg-white">
